...
import { Tilt3D, DotMatrixBg } from '../fx'
  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-50">
        <DotMatrixBg size={6} gap={30} color="rgba(125, 140, 255, 0.35)" speed={0.8} />
      </div>
                ...
                <div className="flex h-full flex-col">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 opacity-40">
                      <DotMatrixBg size={4} gap={34} color="rgba(255,255,255,0.5)" speed={1.4} />
                    </div>
                    <div className="relative flex h-14 w-14 items-center justify-center rounded-2xl border border-white/25 bg-white/15 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
                  ...
                  <div className="flex flex-1 flex-col p-6 sm:p-7">
                    ...
                    <h3 className="mt-4 font-display text-xl font-semibold tracking-tight text-txt sm:text-[22px] transition-transform duration-300 group-hover:translate-x-1">
                      {p.title}
                    </h3>
                    ...
                    <div className="mt-auto flex gap-3 pt-7">
                      <Magnet padding={40} magnetStrength={30}>
                        <a
                          href="#"
                          className="inline-flex items-center gap-2 rounded-full border border-line-strong px-4 py-2 text-[13px] font-semibold text-txt transition-all hover:bg-raised hover:border-accent/50"
                        >
                      ...
                      <Magnet padding={40} magnetStrength={30}>
                        <a
                          href="#"
                          className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-[13px] font-semibold text-txt transition-all hover:bg-raised"
                        >
